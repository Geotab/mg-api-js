...
class ApiHelper {
    ...
    constructor(credentials, newOptions){
        this.options = {
            rememberMe: newOptions.rememberMe || true,
            debug: newOptions.debug || false,
            timeout: newOptions.timeout || 0,
            newCredentialStore: newOptions.newCredentialStore || false
        }
        this.credentialStore = this.createStore(newOptions.newCredentialStore);
