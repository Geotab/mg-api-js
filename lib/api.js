...
//         password: password
//       }, function (data) {
//         if (data.server && data.server !== 'ThisServer') {
//           server = 'https://' + data.server + '/'
//         }
...
//       let api = new Geotab(getCredentials, newOptions);
//       api.call(method, params, callbackSuccess, callbackError);
//       return api;
